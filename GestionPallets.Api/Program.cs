...
using GestionPallets.Infrastructure.Services;
...
builder.Services.AddMediatR(cfg => cfg.RegisterServicesFromAssembly(typeof(CreatePalletCommand).Assembly));
builder.Services.AddMediatR(cfg => cfg.RegisterServicesFromAssembly(typeof(DeletePalletCommand).Assembly));
builder.Services.AddDbContext<AppDbContext>(options =>
    options.UseInMemoryDatabase("StockDatabase"));

builder.Services.AddScoped<IPalletManagementRepository, PalletManagementRepository>();
